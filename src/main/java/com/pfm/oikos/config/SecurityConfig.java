    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        return http
                ...
                .authorizeHttpRequests(
                        req->req.requestMatchers("/login/**", "/register/**", "/api/v1/fincas/**", "/api/v1/propiedades/**",  "/api/v1/entradasForo/**").permitAll()  // Allow access to these paths without authorization
